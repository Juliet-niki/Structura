      ...
      <div className="container mx-auto max-w-7xl">
        ...
        <div className="flex flex-col lg:flex-row gap-12 mt-12">
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="font-semibold text-lg">contact@structura.com</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="font-semibold text-lg">123 Engineering Blvd,<br/>Construct City, ST 90210</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="lg:w-2/3">
            <form onSubmit={handleSubmit} className="bg-white rounded-2xl p-8 text-slate-900 shadow-xl">
              {submitted ? (
                ...
                <>
                  ...
                  <button 
                    ...
                    className={`w-full py-4 px-6 rounded-lg font-bold text-white transition-all transform ${isSubmitting ? 'bg-slate-400 cursor-not-allowed' : 'bg-primary-600 hover:bg-primary-700 hover:shadow-lg active:scale-[0.99]'}`}
                  >
