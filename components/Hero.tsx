...
const Hero: React.FC = () => {
  return (
    <section className="relative w-full h-screen min-h-[600px] flex items-center justify-center overflow-hidden bg-slate-900">
      ...
      <div className="relative z-10 container mx-auto px-6 text-center md:text-left md:flex md:items-center md:justify-between h-full pt-20">
        <div className="max-w-3xl">
          ...
          <p className="text-lg md:text-xl text-slate-300 mb-8 max-w-2xl leading-relaxed">
            Expert civil engineering services from structural design and land
            surveying to property legitimacy verification. We turn complex plans
        ...
        <div className="hidden lg:block w-1/3 max-w-sm">
          <div className="bg-slate-800/50 backdrop-blur-md border border-slate-700 p-6 rounded-2xl shadow-2xl">
            <div className="flex items-center gap-4 mb-4 border-b border-slate-700 pb-4">
              <div className="h-12 w-12 rounded-full bg-primary-900/50 flex items-center justify-center text-primary-400 font-bold text-xl">
                20+
              </div>
              <div>
                <p className="text-white font-bold">Years Experience</p>
                <p className="text-slate-400 text-sm">In Civil Engineering</p>
              </div>
            </div>
            <div className="flex items-center gap-4">
              <div className="h-12 w-12 rounded-full bg-emerald-900/50 flex items-center justify-center text-emerald-400 font-bold text-xl">
                500+
              </div>
              <div>
                <p className="text-white font-bold">Projects Completed</p>
                <p className="text-slate-400 text-sm">Across the Region</p>
              </div>
            </div>
          </div>
        </div>
